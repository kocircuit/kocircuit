...
func (*Symbol_Variety) isSymbol_Symbol() {}
...
func (m *Symbol) GetVariety() *SymbolVariety {
	if x, ok := m.GetSymbol().(*Symbol_Variety); ok {
		return x.Variety
	}
	return nil
}
...
func _Symbol_OneofMarshaler(msg proto1.Message, b *proto1.Buffer) error {
	...
	case *Symbol_Variety:
		...
		if err := b.EncodeMessage(x.Variety); err != nil {
			return err
		}
	case nil:
	default:
...
func _Symbol_OneofUnmarshaler(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error) {
	...
	case 6: // symbol.blob
		...
		return true, err
	case 7: // symbol.variety
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(SymbolVariety)
		err := b.DecodeMessage(msg)
		m.Symbol = &Symbol_Variety{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*SymbolBasic) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{1} }
...
func (*SymbolSeries) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{2} }
...
func (*SymbolStruct) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{3} }
...
func (*SymbolField) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{4} }
...
func (*SymbolMap) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{5} }
...
func (*SymbolKeyValue) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{6} }
...
func (*SymbolBlob) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{7} }
...
func (m *SymbolVariety) Reset()                    { *m = SymbolVariety{} }
func (m *SymbolVariety) String() string            { return proto1.CompactTextString(m) }
func (*SymbolVariety) ProtoMessage()               {}
func (*SymbolVariety) Descriptor() ([]byte, []int) { return fileDescriptorSymbol, []int{8} }
...
func init() {
	...
	proto1.RegisterType((*SymbolVariety)(nil), "ko.symbol.SymbolVariety")
}
...
func (m *Symbol_Struct) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Struct != nil {
		...
		n4, err := m.Struct.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *Symbol_Blob) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Blob != nil {
		...
		n6, err := m.Blob.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *Symbol_Variety) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Variety != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintSymbol(dAtA, i, uint64(m.Variety.Size()))
		n7, err := m.Variety.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *SymbolVariety) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PkgPath == nil {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintSymbol(dAtA, i, uint64(len(*m.PkgPath)))
	...
	if m.FuncName == nil {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintSymbol(dAtA, i, uint64(len(*m.FuncName)))
...
func (m *SymbolVariety) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SymbolVariety: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SymbolVariety: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			m.Arg = append(m.Arg, &SymbolField{})
...
var fileDescriptorSymbol = []byte{
	...
	,
}
