...
func MixNValue(n int, v reflect.Value) string {
	...
	case reflect.String:
		...
		return MixN(n, typs, v.String())
	case reflect.Bool:
		return MixN(n, typs, strconv.FormatBool(v.Bool()))
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		return MixN(n, typs, strconv.FormatInt(v.Int(), 10))
	case reflect.Uint, reflect.Uint8, reflect.Uint16, reflect.Uint32, reflect.Uint64, reflect.Uintptr:
		return MixN(n, typs, strconv.FormatUint(v.Uint(), 10))
	case reflect.Float32, reflect.Float64:
		return MixN(n, typs, strconv.FormatFloat(v.Float(), 'e', -1, 64))
	case reflect.UnsafePointer:
		return MixN(n, typs, strconv.FormatUint(uint64(v.UnsafeAddr()), 16))
	case reflect.Complex64, reflect.Complex128:
		return MixN(n, typs, fmt.Sprintf("%v", v.Interface()))
