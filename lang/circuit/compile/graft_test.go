		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"0_enter_etc", Select{Path: []string{"etc"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
		},
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"0_enter_x", Select{Path: []string{"x"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_y", Select{Path: []string{"y"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
		},
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"0_enter_g", Select{Path: []string{"g"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_h", Select{Path: []string{"h"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
		},
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"0_enter_u", Select{Path: []string{"u"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_v", Select{Path: []string{"v"}}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
			"f": &Func{
