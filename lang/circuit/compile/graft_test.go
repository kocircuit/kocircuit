		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"return", Number{Value: LexFloat{Float64: 3.14}}, nil},
					{"1", Operator{Path: []string{"H"}}, nil},
					{"3", Operator{Path: []string{"H"}}, nil},
					{"0_enter_etc", Link{Name: "etc"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
		},
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"1", PkgFunc{Pkg: "path/to/pkg", Func: "G"}, nil},
					{"0_enter_x", Link{Name: "x"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_y", Link{Name: "y"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
		},
		...
		Pkg: Package{
			...
			"F": &Func{
				...
				Step: testBody{
					...
					{"3", PkgFunc{Pkg: "path/to/pkg", Func: "G"}, nil},
					{"p", PkgFunc{Pkg: "ko/test", Func: "H"}, nil},
					{"q", Invoke{}, []testGather{{MainFlowLabel, "2"}}},
					{"2", Augment{}, []testGather{{MainFlowLabel, "1"}, {"x", "0_enter_x"}, {"y", "0_enter_y"}}},
					{"1", PkgFunc{Pkg: "ko/test", Func: "H"}, nil},
					{"0_enter_x", Link{Name: "x"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_y", Link{Name: "y"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"1", PkgFunc{Pkg: "path/to/pkg", Func: "G"}, nil},
					{"x", Number{Value: LexInteger{Int64: 1}}, nil},
					{"y", Number{Value: LexString{String: "a"}}, nil},
					{"0_enter_g", Link{Name: "g"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_h", Link{Name: "h"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
		},
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"0_leave", Leave{}, []testGather{{MainFlowLabel, "return"}}},
					{"0_enter", Enter{}, nil},
					{"return", PkgFunc{Pkg: "ko/test", Func: "f"}, nil},
				}.Make(),
			},
			"f": &Func{
				ID:    FuncID("ko/test", "f"),
				...
				Step: testBody{
					...
					{"1", PkgFunc{Pkg: "ko/test", Func: "F"}, nil},
					{"0_enter_g", Link{Name: "g"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_h", Link{Name: "h"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
		...
		Pkg: Package{
			"F": &Func{
				...
				Step: testBody{
					...
					{"0_inline_0_return_0_series_0", PkgFunc{Pkg: "ko/test", Func: "f"}, nil},
					{"0_enter_u", Link{Name: "u"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter_v", Link{Name: "v"}, []testGather{{MainFlowLabel, "0_enter"}}},
					{"0_enter", Enter{}, nil},
				}.Make(),
			},
			"f": &Func{
